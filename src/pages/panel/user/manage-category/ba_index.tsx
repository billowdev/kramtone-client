...
import { DeleteDialog, EditDialog } from "@/components/User/ManageCategory";
...
const UserPanelManageCategory = ({ categoryArray, gid, accessToken }: PageProps) => {
  ...
  const handleAddConfirm = (category: CategoryPayload) =>{
  ...
  const handleDelete = (selectRow: CategoryPayload) => {
    // const groupId = gid!;
  ...
  const handleEdit = (selectRow: CategoryPayload) => {
    setSelectedCategory(selectRow);
