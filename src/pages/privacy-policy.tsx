...
const PrivacyPolicy: NextPage = () => {
  ...
  return (
    <MainLayout>
      ...
      <Root maxWidth="md">
        <PageTitle variant="h4" align="center" className={classes.PageTitle}>
          ...
          */}
          ...
          <Box>
            ...
            <Typography variant="body1" paragraph>
              ...
              บังคับใช้ครั้งแรกเมื่อวันที่ 1 พฤษภาคม 2566
          ...
          <Box>
            ...
            <Box>
              <Typography variant="body1" paragraph className={classes.p1Extra}>
                (ก) วัตถุประสงค์แห่งการเก็บรวบรวมและใช้ข้อมูลส่วนบุคคล
              </Typography>

              <Typography variant="body1" paragraph className={classes.p2}>
                {!isSmallDevice && (
                  <React.Fragment>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  </React.Fragment>
            ...
            <Box>
              ...
              <Typography variant="body1" paragraph className={classes.p2}>
                ...
                ผู้ใช้งานรับทราบตกลงและยินยอมให้ผู้ควบคุมข้อมูลเก็บรวบรวม
                ใช้ข้อมูลส่วนบุคคล
                และเก็บรักษาข้อมูลส่วนบุคคลของคุณไว้ตามระยะเวลาที่จำเป็นในระหว่างที่คุณเป็นลูกค้าหรือมีความสัมพันธ์อยู่กับเราหรือตลอดระยะเวลาที่จำเป็นเพื่อให้บรรลุวัตถุประสงค์ที่เกี่ยวข้องกับนโยบายฉบับนี้
          ...
          <Box>
            ...
            <Typography variant="body1" paragraph className={classes.p3Start}>
          ...
          <Box>
            ...
            <Typography variant="body1" paragraph className={classes.p4}>
          ...
          <Box>
            <Typography variant="h5" paragraph className={classes.topic}>
              ข้อ 11 เทคโนโลยีติดตามผู้ใช้ (คุกกี้)
            </Typography>
            <Typography variant="body1" paragraph className={classes.p1}>
              {!isSmallDevice && (
                <React.Fragment>
              ...
              เพื่อปรับปรุงประสบการณ์การใช้งานและเพิ่มความสะดวกสบายของคุณ
              เราใช้คุกกี้ หรือเทคโนโลยีที่คล้ายกัน
              เพื่อสนับสนุนการเข้าถึงและใช้งานสินค้าหรือบริการ
              ปรับโฆษณาให้เหมาะสม และวิเคราะห์ข้อมูลการใช้งานของคุณ
              คุกกี้จะช่วยระบุและติดตามผู้ใช้เว็บไซต์
              พร้อมวิเคราะห์การเข้าสู่เว็บไซต์ของเรา
              หากคุณไม่ประสงค์ให้คุกกี้ถูกเก็บไว้ในคอมพิวเตอร์ของคุณ
              คุณสามารถปรับการตั้งค่าบราวเซอร์เพื่อปฏิเสธคุกกี้ก่อนใช้งานเว็บไซต์ของเรา
            </Typography>
            ...
            <Typography variant="body1" paragraph className={classes.p1}>
              ...
              คุกกี้เป็นไฟล์ข้อความขนาดเล็กที่ถูกดาวน์โหลดไปยังคอมพิวเตอร์
              โทรศัพท์มือถือ หรืออุปกรณ์ของคุณเมื่อคุณเข้าเว็บไซต์
              คุกกี้จะถูกส่งกลับไปยังเว็บไซต์นั้น ๆ
              หรือส่งไปยังเว็บไซต์ที่สามารถรับรู้คุกกี้
              คุกกี้มีข้อดีในการทำให้เว็บไซต์จำอุปกรณ์ของคุณได้
              คุกกี้สามารถแบ่งออกเป็น Persistent cookies
              ที่ยังคงอยู่ในอุปกรณ์เป็นระยะเวลาที่กำหนด และ Session cookies
              ที่เกิดขึ้นระหว่างการใช้งานเบราว์เซอร์
              และจะหายไปเมื่อปิดเบราว์เซอร์ คุกกี้มีหลายฟังก์ชัน เช่น
              ง่ายต่อการเปิดหน้าเว็บต่าง ๆ จำการเข้าเว็บไซต์
              และปรับปรุงประสบการณ์การใช้งานของผู้เข้าเว็บไซต์ นอกจากนี้
              คุกกี้ยังช่วยให้โฆษณาที่คุณเห็นบนเว็บไซต์ตรงกับความสนใจของคุณมากขึ้น
              หากต้องการข้อมูลเพิ่มเติมเกี่ยวกับคุกกี้ คุณสามารถเยี่ยมชม
              www.allaboutcookies.org และ www.youronlinechoices.eu
            </Typography>
          </Box>
          ...
          <Box>
            <Typography variant="h5" paragraph className={classes.topic}>
              ข้อ 12 การใช้งานเว็บไซต์ของบุคคลซึ่งอยู่ในความปกครอง อนุบาล
          ...
          <Box>
            ...
            <Typography
              ...
              paragraph
              style={{
                marginLeft: isSmallDevice ? "16px" : "32px",
                marginTop: "16px",
              }}
            >
          ...
          <Box>
            <Typography variant="h5" paragraph className={classes.topic}>
              ข้อ 16 นโยบายความเป็นส่วนตัวเฉพาะเว็บไซต์ของเรา
            </Typography>
            <Typography variant="body1" paragraph className={classes.p1}>
              {!isSmallDevice && (
                <React.Fragment>
              ...
              นโยบายความเป็นส่วนตัวนี้ใช้เฉพาะกับการนำเสนอสินค้า บริการ
              และการใช้งานเว็บไซต์ของเราเท่านั้น
              ในกรณีที่เว็บไซต์ของเรามีลิงก์เชื่อมโยงไปยังเว็บไซต์อื่น ๆ
              ที่อยู่นอกการควบคุมของเรา
              นโยบายนี้จะไม่สามารถประยุกต์ใช้กับเว็บไซต์เหล่านั้น
              ข้อมูลที่เก็บไว้ในเว็บไซต์เหล่านั้นจะถูกจัดการตามนโยบายความเป็นส่วนตัวของเว็บไซต์นั้น
              ๆ ซึ่งอาจแตกต่างจากนโยบายของเรา
            </Typography>
          </Box>
